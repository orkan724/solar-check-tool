...
# Funktion zur Überprüfung der Solaranlage mit verbessertem Fehlerhandling
def check_solar_installation(address):
    ...
    try:
        response = requests.get(url, headers=headers, params=params, timeout=15, verify=False)  # SSL-Validierung deaktivieren
